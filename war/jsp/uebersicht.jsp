 ...
 <logic:present name="overviewform" property="bestellungen">
   <logic:iterate id="b" name="overviewform" property="bestellungen">
     <tr>      
      ...
      <!-- <td id="border"><a href="reorder.do?method=prepareReorder&bid=<bean:write name="b" property="id" />"><img border="0" src="img/reorder.png" alt="<bean:message key="uebersicht.reorder" />" title="<bean:message key="uebersicht.reorder" />"/></a></td> -->
      ...
      <td id="border"><bean:write name="b" property="orderdate" />&nbsp;</td>
      <td id="border">
    ...
    <td id="border"><bean:write name="b" property="statusdate" />&nbsp;</td>
      ...
      <td id="border"><bean:write name="b" property="artikeltitel" /><bean:write name="b" property="kapitel" />&nbsp;</td>
      <td id="border">
    ...
    <td id="border"><a href="journalorderdetail.do?method=journalorderdetail&bid=<bean:write name="b" property="id" />"><img src="img/details.png" alt="<bean:message key="uebersicht.details" />" title="<bean:message key="uebersicht.details" />" border="0"></a></td>
    </tr>
   </logic:iterate>
</logic:present>
