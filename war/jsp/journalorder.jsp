...
<input name="mediatype" type="hidden" value="<bean:write name="orderform" property="mediatype" />" /> 
    <tr>   
      ...
      <!-- GBV akzeptiert f�r den Moment nur Bestellungen per Post, obwohl technisch m�glich...
...
-->
  <tr>
  <td><input type="submit" name="submit" value="<bean:message key="order.order" />"></td>
  <td><br>&nbsp;&nbsp;</td>
