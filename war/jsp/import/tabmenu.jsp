...
<table style="width:1120px;">
  <tr>
    <td width="<%=wdth%>" <logic:present name="ActiveMenus" property="activemenu"><logic:equal name="ActiveMenus" property="activemenu" value="login">id="menuActive"</logic:equal></logic:present>>
      <logic:present name="orderform" property="resolver"><logic:equal name="orderform" property="resolver" value="true"><a href="pl.do?<logic:present name="orderform">mediatype=<bean:write name="orderform" property="mediatype" />&issn=<bean:write name="orderform" property="issn" />&jahr=<bean:write name="orderform" property="jahr" />&jahrgang=<bean:write name="orderform" property="jahrgang" />&heft=<bean:write name="orderform" property="heft" />&seiten=<bean:write name="orderform" property="seiten" />&isbn=<bean:write name="orderform" property="isbn" />&artikeltitel=<bean:write name="orderform" property="artikeltitel" />&zeitschriftentitel=<bean:write name="orderform" property="zeitschriftentitel" />&author=<bean:write name="orderform" property="author" />&kapitel=<bean:write name="orderform" property="kapitel" />&buchtitel=<bean:write name="orderform" property="buchtitel" />&verlag=<bean:write name="orderform" property="verlag" />&rfr_id=<bean:write name="orderform" property="rfr_id" />&genre=<bean:write name="orderform" property="genre" />&pmid=<bean:write name="orderform" property="pmid" />&doi=<bean:write name="orderform" property="doi" />&sici=<bean:write name="orderform" property="sici" />&zdbid=<bean:write name="orderform" property="zdbid" />&lccn=<bean:write name="orderform" property="lccn" />&artikeltitel=<bean:write name="orderform" property="artikeltitel" />&author=<bean:write name="orderform" property="author" /></logic:present>"><bean:message key="tabmenu.slide.login" /></a></logic:equal><logic:equal name="orderform" property="resolver" value="false"><a href="login.do?activemenu=login"><bean:message key="tabmenu.slide.login" /></a></logic:equal></logic:present><logic:notPresent name="orderform" property="resolver"><a href="login.do?activemenu=login"><bean:message key="tabmenu.slide.login" /></a></logic:notPresent>
    </td>
