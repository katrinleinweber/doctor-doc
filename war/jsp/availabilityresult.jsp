...
<p></p>
  <logic:notPresent name="orderform" property="bid">
    <div id="italic"><bean:message key="save.artikel" /> <bean:message key="save.gefunden" /> <a href="prepareJournalSave.do?method=prepareJournalSave&issn=<bean:write name="orderform" property="issn" />&jahr=<bean:write name="orderform" property="jahr" />&jahrgang=<bean:write name="orderform" property="jahrgang" />&heft=<bean:write name="orderform" property="heft" />&seiten=<bean:write name="orderform" property="seiten" /><logic:present name="orderform" property="foruser">&foruser=<bean:write name="orderform" property="foruser" /></logic:present>&status=erledigt<logic:present name="orderform" property="lieferant.lid">&lid=<bean:write name="orderform" property="lieferant.lid" /></logic:present><logic:present name="orderform" property="deloptions">&deloptions=<bean:write name="orderform" property="deloptions" /></logic:present><logic:notPresent name="orderform" property="deloptions">&deloptions=email</logic:notPresent>&preisvorkomma=0&preisnachkomma=00&artikeltitel=<bean:write name="orderform" property="artikeltitel" />&zeitschriftentitel=<bean:write name="orderform" property="zeitschriftentitel" />&author=<bean:write name="orderform" property="author" />&pmid=<bean:write name="orderform" property="pmid" />&doi=<bean:write name="orderform" property="doi" />"><font color="white"><bean:message key="save.speichern" /></font></a> <bean:message key="save.statistik" /></div>
  </logic:notPresent>
 ...
 <logic:notEmpty name="orderform" property="issn">
   <table class="border">
    ...
    <tr>
      ...
      <td id="border"><a href="http://aleph20-prod-acc.obvsg.at/F?func=find-b&find_code=ISN&request=<bean:write name="orderform" property="issn" />" target="_blank"><bean:message key="availresult.gesamtkatalog" /></a></td>
      ...
      <td id="border"><a href="http://www.google.ch/search?as_q=&num=10&btnG=Google-Suche&as_epq=<bean:write name="orderform" property="artikeltitel" />&as_oq=pdf+full-text&as_eq=&lr=&as_ft=i&as_filetype=&as_qdr=all&as_occt=any&as_dt=i&as_sitesearch=&as_rights=&safe=images" target="_blank">Google</a></td>
    </tr>
    <tr>
      ...
      <td id="border" width="25%"><a href="http://scholar.google.com/scholar?as_q=&num=10&btnG=Scholar-Suche&as_epq=<bean:write name="orderform" property="artikeltitel" />&as_oq=&as_eq=&as_occt=any&as_sauthors=&as_publication=&as_ylo=&as_yhi=&lr=" target="_blank">Google Scholar</a></td>
    </tr>
    <tr>
      ...
      <td id="border" colspan="2"><a href="http://www.swissbib.ch/TouchPoint/start.do?Language=de&View=nose&Query=540=%22<bean:write name="orderform" property="issn" />%22" target="_blank">Swissbib</a></td>
      <td id="border">&nbsp;</td>
      <td id="border">&nbsp;</td>
      <td id="border"><a href="http://worldcatlibraries.org/registry/gateway?genre=article&issn=<bean:write name="orderform" property="issn" />&date=<bean:write name="orderform" property="jahr" />&volume=<bean:write name="orderform" property="jahrgang" />&issue=<bean:write name="orderform" property="heft" />&pages=<bean:write name="orderform" property="seiten" />&title=<bean:write name="orderform" property="zeitschriftentitel" />&atitle=<bean:write name="orderform" property="artikeltitel" />&aulast=<bean:write name="orderform" property="author" />" target="_blank">WorldCat</a></td>
    </tr>
    <tr>
      <td id="border"><a href="http://www.gbv.de/gso/opengso.php?sid=DRDOC:doctor-doc&db=GVK+&genre=article&issn=<bean:write name="orderform" property="issn" />&date=<bean:write name="orderform" property="jahr" />&volume=<bean:write name="orderform" property="jahrgang" />&issue=<bean:write name="orderform" property="heft" />&pages=<bean:write name="orderform" property="seiten" />&title=<bean:write name="orderform" property="zeitschriftentitel" />&atitle=<bean:write name="orderform" property="artikeltitel" />&aulast=<bean:write name="orderform" property="author" />" target="_blank">GBV/GVK+</a></td>
    ...
    <tr>
      ...
      <td id="border"><a href="http://library.epfl.ch/periodicals/?stype=&ti=&pu=&me=&status=&lib=&shelfmark=&-find=CHERCHER&issn=<bean:write name="orderform" property="issn" />" target="_blank">EPFL</a></td>
      <td id="border"><a href="http://library.epfl.ch/pret-inter/?pg=article&pSerial=<bean:write name="orderform" property="zeitschriftentitel" />&pYear=<bean:write name="orderform" property="jahr" />&pVolume=<bean:write name="orderform" property="jahrgang" />&pIssue=<bean:write name="orderform" property="heft" />&pPage=<bean:write name="orderform" property="seiten" />&pAuthor=<bean:write name="orderform" property="author" />&pTitle=<bean:write name="orderform" property="artikeltitel" />&pIsbn=<bean:write name="orderform" property="issn" />&uComment=&uName=<bean:write name="userinfo" property="konto.bibliotheksname" />%20%2F%20<bean:write name="userinfo" property="benutzer.vorname" />%20<bean:write name="userinfo" property="benutzer.name" />&uStatus=other&uNebis=<logic:present name="userinfo" property="konto.idsid"><bean:write name="userinfo" property="konto.idsid" /></logic:present>&uEmail=<bean:write name="userinfo" property="konto.dbsmail" />&uAddress=<bean:write name="userinfo" property="konto.adresse" />%2C%20<bean:write name="userinfo" property="konto.adressenzusatz" />%2C%20<bean:write name="userinfo" property="konto.PLZ" />%20<bean:write name="userinfo" property="konto.ort" />&uPhone=<bean:write name="userinfo" property="konto.telefon" />" target="_blank"><bean:message key="tabmenu.slide.order"/></a></td>
      <td id="border">&nbsp;</td>
      <td id="border">&nbsp;</td>
      <td id="border">&nbsp;</td>
    </tr>
    <tr>
      ...
      <td id="border"><a href="http://ml.metabib.ch/V/?func=quick-1-check1&mode=advanced&find_request_1=&find_code_2=ISSN&find_op_1=AND&find_code_3=WRD&find_request_3=&group_number=000002060&find_request_2=<bean:write name="orderform" property="issn" />" target="_blank">UB Basel</a></td>
    ...
    <tr>
      ...
      <td id="border"><a href="http://www.zb.unibe.ch/unicd/docdel.php?Journal=<bean:write name="orderform" property="zeitschriftentitel" />&Author=<bean:write name="orderform" property="author" />&Article=<bean:write name="orderform" property="artikeltitel" />&Volume=<bean:write name="orderform" property="jahrgang" />&Issue=<bean:write name="orderform" property="heft" />&Year=<bean:write name="orderform" property="jahr" />&Pages=<bean:write name="orderform" property="seiten" />&ISSN=<bean:write name="orderform" property="issn" />&meduid=<bean:write name="orderform" property="pmid" />&sid=doctor-doc&Publisher=<bean:write name="orderform" property="verlag" />&PubliPlace=&ou=&bennr=<logic:present name="userinfo" property="konto.idsid"><bean:write name="userinfo" property="konto.idsid" /></logic:present>&passwort=<logic:present name="userinfo" property="konto.idspasswort"><bean:write name="userinfo" property="konto.idspasswort" /></logic:present>&wo_bestellen=schweiz&mitteilung=" target="_blank"><bean:message key="tabmenu.slide.order"/></a></td>
      <td id="border">&nbsp;</td>
      <td id="border">&nbsp;</td>
      <td id="border">&nbsp;</td>
    </tr>
    <tr>
      <td id="border">&nbsp;</td>
      <td id="border"><a href="http://ml.metabib.ch/V/?func=quick-1-check1&mode=advanced&find_request_1=&find_code_2=ISSN&find_op_1=AND&find_code_3=WRD&find_request_3=&group_number=000002060&find_request_2=<bean:write name="orderform" property="issn" />" target="_blank">MBC Z&uuml;rich</a></td>
  ...
  <p>
    <logic:notPresent name="orderform" property="bid">
      <font color="white"><i><bean:message key="save.extern" /> <a href="prepareJournalSave.do?method=prepareJournalSave&issn=<bean:write name="orderform" property="issn" />&jahr=<bean:write name="orderform" property="jahr" />&jahrgang=<bean:write name="orderform" property="jahrgang" />&heft=<bean:write name="orderform" property="heft" />&seiten=<bean:write name="orderform" property="seiten" /><logic:present name="orderform" property="foruser">&foruser=<bean:write name="orderform" property="foruser" /></logic:present>&status=bestellt&deloptions=email&artikeltitel=<bean:write name="orderform" property="artikeltitel" />&zeitschriftentitel=<logic:present name="orderform" property="zeitschriftentitel"><bean:write name="orderform" property="zeitschriftentitel"/></logic:present>&author=<bean:write name="orderform" property="author" />&pmid=<bean:write name="orderform" property="pmid" />&doi=<bean:write name="orderform" property="doi" />"><font color="white"><bean:message key="save.speichern" /></font></a> <bean:message key="save.statistik" /></i></font>
    </logic:notPresent>
    <logic:present name="orderform" property="bid">
 ...
 <div id="italic"><bean:message key="availresult.manuell" /></div><br>
   <table class="border">
    ...
    <tr>
      ...
      <td id="border"><a href="http://aleph20-prod-acc.obvsg.at/F?CON_LNG=ger&func=file&file_name=start&local_base=acczs" target="_blank"><bean:message key="availresult.gesamtkatalog" /></a></td>
      ...
      <td id="border"><a href="http://www.google.ch/search?as_q=&num=4&btnG=Google-Suche&as_epq=<bean:write name="orderform" property="artikeltitel" />&as_oq=pdf+full-text&as_eq=&lr=&as_ft=i&as_filetype=&as_qdr=all&as_occt=any&as_dt=i&as_sitesearch=&as_rights=&safe=images" target="_blank">Google</a></td>
    </tr>
        <tr>
      ...
      <td id="border">&nbsp;</td>
      <td id="border"><a href="http://locatorplus.gov/cgi-bin/Pwebrecon.cgi?Search_Arg=<bean:write name="orderform" property="zeitschriftentitel_encoded" />&Search_Code=JALL&CNT=25&HIST=1" target="_blank">NLM</a></td>
      <td id="border" width="25%"><a href="http://scholar.google.com/scholar?as_q=&num=10&btnG=Scholar-Suche&as_epq=<bean:write name="orderform" property="artikeltitel" />&as_oq=&as_eq=&as_occt=any&as_sauthors=&as_publication=&as_ylo=&as_yhi=&lr=" target="_blank">Google Scholar</a></td>
    </tr>
    <tr>
      <td id="border"><a href="http://gso.gbv.de/DB=2.1/" target="_blank">GBV/GVK</a></td>
      <td id="border" colspan="2"><a href="http://www.swissbib.ch/TouchPoint/start.do?Language=de&View=nose&Query=331=%22<bean:write name="orderform" property="zeitschriftentitel" />%22" target="_blank">Swissbib</a></td>
      <td id="border">&nbsp;</td>
      <td id="border">&nbsp;</td>
      <td id="border">&nbsp;</td>
    </tr>
    ...
    <tr>
      ...
      <td id="border"><a href="http://library.epfl.ch/periodicals/?stype=&ti=<bean:write name="orderform" property="zeitschriftentitel" />&pu=&issn=&me=&status=&lib=&shelfmark=&-find=CHERCHER" target="_blank">EPFL</a></td>
      <td id="border"><a href="http://library.epfl.ch/pret-inter/?pg=article&pSerial=<bean:write name="orderform" property="zeitschriftentitel" />&pYear=<bean:write name="orderform" property="jahr" />&pVolume=<bean:write name="orderform" property="jahrgang" />&pIssue=<bean:write name="orderform" property="heft" />&pPage=<bean:write name="orderform" property="seiten" />&pAuthor=<bean:write name="orderform" property="author" />&pTitle=<bean:write name="orderform" property="artikeltitel" />&pIsbn=<bean:write name="orderform" property="issn" />&uComment=&uName=<bean:write name="userinfo" property="konto.bibliotheksname" />%20%2F%20<bean:write name="userinfo" property="benutzer.vorname" />%20<bean:write name="userinfo" property="benutzer.name" />&uStatus=other&uNebis=<logic:present name="userinfo" property="konto.idsid"><bean:write name="userinfo" property="konto.idsid" /></logic:present>&uEmail=<bean:write name="userinfo" property="konto.dbsmail" />&uAddress=<bean:write name="userinfo" property="konto.adresse" />%2C%20<bean:write name="userinfo" property="konto.adressenzusatz" />%2C%20<bean:write name="userinfo" property="konto.PLZ" />%20<bean:write name="userinfo" property="konto.ort" />&uPhone=<bean:write name="userinfo" property="konto.telefon" />" target="_blank"><bean:message key="tabmenu.slide.order"/></a></td>
      <td id="border">&nbsp;</td>
      <td id="border">&nbsp;</td>
      <td id="border">&nbsp;</td>
    ...
    <tr>
      <td id="border"><a href="http://www.digibib.net/openurl?sid=DRDOC:doctor-doc&genre=article&issn=<bean:write name="orderform" property="issn" />&date=<bean:write name="orderform" property="jahr" />&volume=<bean:write name="orderform" property="jahrgang" />&issue=<bean:write name="orderform" property="heft" />&pages=<bean:write name="orderform" property="seiten" />&title=<bean:write name="orderform" property="zeitschriftentitel" />&atitle=<bean:write name="orderform" property="artikeltitel" />&aulast=<bean:write name="orderform" property="author" />" target="_blank">DigiBib</a></td>
      <td id="border"><a href="http://ml.metabib.ch/V/?func=quick-1-check1&mode=advanced&find_request_1=&find_code_2=WRD&find_op_1=AND&find_code_3=WRD&find_request_3=&group_number=000002060&find_request_2=<bean:write name="orderform" property="zeitschriftentitel" />" target="_blank">UB Basel</a></td>
      <td id="border"><a href="redirectunibasel.do?issn=<bean:write name="orderform" property="issn" />&jahr=<bean:write name="orderform" property="jahr" />&jahrgang=<bean:write name="orderform" property="jahrgang" />&heft=<bean:write name="orderform" property="heft" />&seiten=<bean:write name="orderform" property="seiten" />&artikeltitel=<bean:write name="orderform" property="artikeltitel" />&zeitschriftentitel=<bean:write name="orderform" property="zeitschriftentitel"/>&author=<bean:write name="orderform" property="author" />&pmid=<bean:write name="orderform" property="pmid" />&doi=<bean:write name="orderform" property="doi" />" target="_blank"><bean:message key="tabmenu.slide.order"/></a></td>
      <td id="border">&nbsp;</td>
      <td id="border">&nbsp;</td>
      <td id="border">&nbsp;</td>
    ...
    <tr>
      <td id="border">&nbsp;</td>
      <td id="border"><a href="http://ml.metabib.ch/V/?func=quick-1-check1&mode=advanced&find_request_1=&find_code_2=WRD&find_op_1=AND&find_code_3=WRD&find_request_3=&group_number=000002060&find_request_2=<bean:write name="orderform" property="zeitschriftentitel" />" target="_blank">MBC Z&uuml;rich</a></td>
      <td id="border"><a href="redirectmbczurich.do?issn=<bean:write name="orderform" property="issn" />&jahr=<bean:write name="orderform" property="jahr" />&jahrgang=<bean:write name="orderform" property="jahrgang" />&heft=<bean:write name="orderform" property="heft" />&seiten=<bean:write name="orderform" property="seiten" />&artikeltitel=<bean:write name="orderform" property="artikeltitel" />&zeitschriftentitel=<bean:write name="orderform" property="zeitschriftentitel"/>&author=<bean:write name="orderform" property="author" />&pmid=<bean:write name="orderform" property="pmid" />&doi=<bean:write name="orderform" property="doi" />" target="_blank"><bean:message key="tabmenu.slide.order"/></a></td>
      <td id="border">&nbsp;</td>
      <td id="border">&nbsp;</td>
      <td id="border">&nbsp;</td>
          ...
          <tr>
            ...
            <td id="border">
              <logic:present name="hold" property="holding.baseurl">
              	<a href="<bean:write name="hold" property="holding.baseurl" />/stockinfo.do?holding=<bean:write name="hold" property="holding.id" />&issn=<bean:write name="orderform" property="issn" />&jahr=<bean:write name="orderform" property="jahr" />&jahrgang=<bean:write name="orderform" property="jahrgang" />&heft=<bean:write name="orderform" property="heft" />&seiten=<bean:write name="orderform" property="seiten" />&artikeltitel=<bean:write name="orderform" property="artikeltitel" />&zeitschriftentitel=<logic:present name="orderform" property="zeitschriftentitel"><bean:write name="orderform" property="zeitschriftentitel"/></logic:present>&author=<bean:write name="orderform" property="author" />&pmid=<bean:write name="orderform" property="pmid" />&doi=<bean:write name="orderform" property="doi" />" 
            		target="popup" onclick="wopen('<bean:write name="hold" property="holding.baseurl" />/stockinfo.do?holding=<bean:write name="hold" property="holding.id" />&issn=<bean:write name="orderform" property="issn" />&jahr=<bean:write name="orderform" property="jahr" />&jahrgang=<bean:write name="orderform" property="jahrgang" />&heft=<bean:write name="orderform" property="heft" />&seiten=<bean:write name="orderform" property="seiten" />&artikeltitel=<bean:write name="orderform" property="artikeltitel" />&zeitschriftentitel=<logic:present name="orderform" property="zeitschriftentitel"><bean:write name="orderform" property="zeitschriftentitel"/></logic:present>&author=<bean:write name="orderform" property="author" />&pmid=<bean:write name="orderform" property="pmid" />&doi=<bean:write name="orderform" property="doi" />', 'popup', 1040, 880); return false;"><bean:message key="tabmenu.slide.holdings" /></a>
              </logic:present>
            ...
            <td id="border">
            	<logic:present name="hold" property="holding.baseurl">
            		...
            		target="popup" onclick="wopen('<bean:write name="hold" property="holding.baseurl" />/stockinfo.do?stock=<bean:write name="hold" property="id" />&issn=<bean:write name="orderform" property="issn" />&jahr=<bean:write name="orderform" property="jahr" />&jahrgang=<bean:write name="orderform" property="jahrgang" />&heft=<bean:write name="orderform" property="heft" />&seiten=<bean:write name="orderform" property="seiten" />&artikeltitel=<bean:write name="orderform" property="artikeltitel" />&zeitschriftentitel=<logic:present name="orderform" property="zeitschriftentitel"><bean:write name="orderform" property="zeitschriftentitel"/></logic:present>&author=<bean:write name="orderform" property="author" />&pmid=<bean:write name="orderform" property="pmid" />&doi=<bean:write name="orderform" property="doi" />', 'popup', 1040, 880); return false;"><bean:message key="availresult.details" /></a>
            	</logic:present>
            	<logic:notPresent name="hold" property="holding.baseurl">
