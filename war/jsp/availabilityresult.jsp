 ...
 <logic:notEmpty name="orderform" property="issn">
   <table border="1" cellspacing="0" cellpadding="3">
    ...
    <tr>
      ...
      <td><a href="http://www.zb.unibe.ch/unicd/docdel.php?Journal=<bean:write name="orderform" property="zeitschriftentitel_encodedUTF8" />&Author=<bean:write name="orderform" property="author_encodedUTF8" />&Article=<bean:write name="orderform" property="artikeltitel_encodedUTF8" />&Volume=<bean:write name="orderform" property="jahrgang" />&Issue=<bean:write name="orderform" property="heft" />&Year=<bean:write name="orderform" property="jahr" />&Pages=<bean:write name="orderform" property="seiten" />&ISSN=<bean:write name="orderform" property="issn" />&meduid=<bean:write name="orderform" property="pmid" />&sid=doctor-doc&Publisher=<bean:write name="orderform" property="verlag_encodedUTF8" />&PubliPlace=&ou=&bennr=&passwort=&wo_bestellen=schweiz&mitteilung=" target="_blank"><bean:message key="tabmenu.slide.order"/></a></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
