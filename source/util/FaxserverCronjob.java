...
public class FaxserverCronjob {
    ...
    public FaxserverCronjob(){
    	...
    	// Szenario 2: weiterleiten aller doctor-doc Emails auf ein zentrales Email (fax@doctor-doc.com) => ggf.FaxHelper
    	// Szenario 3: regelmässiges (10-15 Min.) direktes Abfragen aller Faxkonten bei popfax mittels FaxHelper. Lokales Emailkonto nur als Buffer/Backup
