...
public enum TextType {
    ...
    RIGHTS("RIGHTS", 1), STATE_ORDER("STATE_ORDER", 2), STATE_FAX("STATE_FAX", 3), STATE_ACCOUNT("STATE_ACCOUNT", 4), SUPPLIER(
            "SUPPLIER", 5), GTC("GTC", 6), CURRENCY("CURRENCY", 7), BILLING_REASON("BILLING_REASON", 8), IP4("IP4", 9), LOCATION(
            ...
            "USER_CATEGORY", 15), MAIL_SUBJECT("MAIL_SUBJECT", 16), MAIL_BODY("MAIL_BODY", 17), IP6("IP6", 18);
