...
public final class OptimizeDB extends DispatchAction {
    ...
    private static final SimpleLogger LOG = new SimpleLogger(OptimizeDB.class);
    ...
    public void optimizeDB(final ActionMapping mp,
        ...
        try {
            pstmt = cn.getConnection().prepareStatement("OPTIMIZE TABLE `benutzer` , `bestellform_param` , "
