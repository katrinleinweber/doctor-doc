...
public class Lieferanten extends AbstractIdEntity {
    ...
    /**
     * Gets all private Lieferanten for a given account. This is a wrapper
     * method, executing the appropriate method depending on the settings for an
     * account.
     */
    ...
    /**
     * Gets all private Lieferanten for a given account. These suppliers may be
     * editable.
     */
    ...
    /**
     * Gets all public Lieferanten for a given country and all general
     * Lieferanten. These suppliers should not be editable.
     */
