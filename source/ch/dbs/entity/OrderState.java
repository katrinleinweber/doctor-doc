...
public class OrderState extends AbstractIdEntity {
  ...
  public void setNewOrderState(Bestellungen b, Konto k, Text t, String bemerkungen, String bearbeiter, Connection cn){
      ...
      try {            
          ...
          pstmt = cn.prepareStatement( "UPDATE `bestellungen` SET statedate = ?, state = ?, orderdate = ? where bid = ?");
  ...
  public void updateOrderState(Bestellungen b, Text t, String bemerkungen, String bearbeiter, String datum, Connection cn){
