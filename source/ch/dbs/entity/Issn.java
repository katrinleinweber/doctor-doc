...
public ArrayList<String> getAllIssnsFromOneIssn(String issn, Connection cn){
	...
	ResultSet rs = null;
	try {
        pstmt = cn.prepareStatement("SELECT DISTINCT b.issn FROM `issn` AS a JOIN issn AS b ON a.identifier_id = b.identifier_id AND a.identifier = b.identifier WHERE a.issn = ?");
