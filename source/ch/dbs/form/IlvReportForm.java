...
public final class IlvReportForm extends ActionForm {
    ...
    public void setLabelclinicinstitutedepartment(final String labelclinicinstitutedepartment) {
    ...
    public void setLabelendorsementsofdeliveringlibrary(final String labelendorsementsofdeliveringlibrary) {
    ...
    public void setLabelnotesfromrequestinglibrary(final String labelnotesfromrequestinglibrary) {
