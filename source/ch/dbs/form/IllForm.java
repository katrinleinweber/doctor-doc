...
public class IllForm extends ActionForm {
    ...
    private String message_type = ""; // REQUEST, SHIPPED, ANSWER, BILL (Bestellung eines Dokumentes, Mitteilung, dass und wie das Dokument verschickt wurde, Mitteilung zum Status, Mitteilung von Rechnungsinformationen)
    private String transaction_id = ""; // Das Feld transaction-id ist immer leer.
    private String transaction_group_qualifier = ""; // Bestellnummer des auslösenden Systems. Eindeutige Identifikation einer Bestellung.
    ...
    private String del_customer_info_to_keep = ""; // Überschreiben der gespeicherten Angaben mit den vorliegenden Kundenangaben
	...
	public void setTransaction_initial_req_id_symbol(
			String transaction_initial_req_id_symbol) {
	...
	public void setRequester_group(String requester_group) {
	...
	public void setItem_system_no(String item_system_no) {
	...
	public void setTransaction_group_qualifier(String transaction_group_qualifier) {
	...
	public void setTransaction_qualifier(String transaction_qualifier) {
	...
	public void setTransaction_sub_transaction_qualifier(
			String transaction_sub_transaction_qualifier) {
	...
	public void setDel_postal_name_of_person_or_institution(
			String del_postal_name_of_person_or_institution) {
	...
	public void setDel_postal_extended_postal_delivery_address(
			String del_postal_extended_postal_delivery_address) {
	...
	public void setDel_postal_street_and_number(String del_postal_street_and_number) {
	...
	public void setDel_status_level_user(String del_status_level_user) {
	...
	public void setDel_customer_info_to_keep(String del_customer_info_to_keep) {
		this.del_customer_info_to_keep = del_customer_info_to_keep;
	}
	public String getDel_email_address() {
		return del_email_address;
	}
	public void setDel_email_address(String del_email_address) {
	...
	public void setIll_service_type(String ill_service_type) {
	...
	public void setDel_notes(String del_notes) {
	...
	public void setSearch_type_level_of_service(String search_type_level_of_service) {
	...
	public void setSearch_type_expiry_date(String search_type_expiry_date) {
	...
	public void setItem_place_of_publication(String item_place_of_publication) {
	...
	public void setItem_publication_date_of_component(
			String item_publication_date_of_component) {
	...
	public void setResponder_note(String responder_note) {
