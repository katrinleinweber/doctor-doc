...
public final class KontoForm extends ValidatorForm {
    ...
    public void setIsil(String isil) {
        try {
            ...
            if (isil != null) {
                ...
                if ("".equals(isil)) {
                    isil = null;
                } // falls Leerstring, ISIL als null speichern
            }
    ...
    public void setValuesFromKonto() {
        ...
        if (konto.getBibliotheksname() != null) {
            this.biblioname = konto.getBibliotheksname().trim();
        }
        ...
        if (konto.getAdresse() != null) {
            this.Adresse = konto.getAdresse().trim();
        }
        if (konto.getAdressenzusatz() != null) {
            this.Adressenzusatz = konto.getAdressenzusatz().trim();
        }
        if (konto.getPLZ() != null) {
            this.PLZ = konto.getPLZ().trim();
        }
        if (konto.getOrt() != null) {
            this.Ort = konto.getOrt().trim();
        }
        ...
        if (konto.getTelefon() != null) {
            this.Telefon = konto.getTelefon().trim();
        }
        if (konto.getBibliotheksmail() != null) {
            this.Bibliotheksmail = konto.getBibliotheksmail().trim();
        }
        if (konto.getDbsmail() != null) {
            this.dbsmail = konto.getDbsmail().trim();
        }
        ...
        if (konto.getEzbid() != null) {
            this.ezbid = konto.getEzbid();
        }
        this.instlogolink = konto.getInstlogolink();
        this.zdb = konto.isZdb(); // ZDB-Teilnehmer
        if (konto.getBilling() != null) {
            this.billing = konto.getBilling();
        }
        if (konto.getBillingtype() != null) {
            this.billingtype = konto.getBillingtype();
        }
