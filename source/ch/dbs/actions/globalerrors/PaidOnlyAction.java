...
/**
 * Prepares an error message for paid only access.
 */
public class PaidOnlyAction extends DispatchAction {
    ...
    public ActionForward execute(final ActionMapping mp, final ActionForm form, final HttpServletRequest rq,
        ...
        final ErrorMessage em = new ErrorMessage("error.paidonly", "searchfree.do");
