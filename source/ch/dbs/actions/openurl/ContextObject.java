...
public class ContextObject {
	...
	private String rft_val_fmt =""; // enthält Angaben: "journal" / "book" z.B. rft_val_fmt=info:ofi/fmt:kev:mtx:journal
	...
	private String rft_genre =""; 	// Genre of the document. Legitimate values for the "genre" element are:
		...
		// (4) "conference": for a record of a conference that includes one or more conference papers and that is published as an issue of a journal or serial publication
		// (5) "proceeding": for a single conference presentation published in a journal or serial publication
		// (6) "preprint": for an individual paper or report published in paper or electronically prior to its publication in a journal or serial
		// (7) "unknown": use when the genre is unknown.
		// for Books
		// (1) "book": a publication that is complete in one part or a designated finite number of parts, often identified with an ISBN.
		...
		// (5) "report": report or technical report is a published document that is issued by an organization, agency or government body.
		// (6) "document": general document type to be used when available data elements do not allow determination of a more specific document type, i.e. when one has only author and title but no publication information.
	...
	private String rft_series =""; 	// The title of a series in which the book or document was issued. There may also be an ISSN associated with the series. 
	...
	private String rft_part =""; 	// Part can be a special subdivision of a volume or it can be the highest level division of the journal. Parts are often designated with letters or names, e.g. "B", "Supplement"
	private String rft_issue =""; 	// Heft
	private String rft_spage ="";	// start page
	private String rft_epage =""; 	// end page
	private String rft_pages =""; 	// Start and end pages in the form "startpage-endpage". This field can also be used for an unstructured pagination statement when data relating to pagination cannot be interpreted as a start-end pair, i.e. "A7, C4-9", "1-3, 6"
	private String rft_tpages =""; 	// Total pages. Total pages is the largest recorded number of pages, if this can be determined. I.e., "ix, 392 p." would be recorded as "392" in tpages. This data element is usually available only for monographs (books and printed reports). In some cases, tpages may not be numeric, i.e. "F36"
	private String rft_author =""; 	// The author's full name, i.e. "Smith, Fred M", "Harry S. Truman"
	private String rft_au ="";	 	// kein offizieller Identifikator für Author. The author's full name, i.e. "Smith, Fred M", "Harry S. Truman"
	...
	private String rft_ausuffix ="";// First author's name suffix. Qualifiers on an author's name such as "Jr.", "III" are entered here. i.e. Smith, Fred Jr. is recorded as "ausuffux=jr"
	private String rft_aucorp =""; 	// Organization or corporation that is the author or creator of the book, i.e. "MellonFoundation"
	...
	private String rft_artnum =""; 	// Article number assigned by the publisher. Article numbers are often generated for publications that do not have usable pagination, in particular
		// electronic journal articles, e.g. "unifi000000090". If article numbers are identifiers that follow a URI Scheme such as "info:doi/"
		// the information should be provided in the Identifier Descriptor of the ContextObject, not in this "artnum" element. Likewise, if
		// articles are identified by means of a registered URI Scheme such as the http scheme, the information should be provided in the Identifier Descriptor of the ContextObject
	...
	private String rft_identifier ="";  	// kein offizieller Identifikator für URL (z.B. http://biblionik.de/2008/07/21/ordnung-im-blog-feedback/)
